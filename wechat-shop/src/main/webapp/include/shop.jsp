...
<div class="content" id="contents">
    ...
    <div id="productList">
        ...
        <s:iterator value="lists" var="goods">
            <a href="goodsInfo?goodsId=<s:property value="#goods.goodsId"/>&storeId=<s:property value="shopId"/>&wechatId=<s:property value="wechatId"/>"
               style="font-size:30px;margin: 0 auto" class="link">
                <div class="card">
                ...
                success: function (data) {
                    if (data.length != 0) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            var appendData = '<a href="goodsInfo?goodsId=' + data[i].goodsId + '&storeId=' + data[i].storeId + '&wechatId=<s:property value="wechatId"/>" class="link"><div class="card">'
                                + '<div valign="bottom" class="card-header color-white no-border no-padding">'
