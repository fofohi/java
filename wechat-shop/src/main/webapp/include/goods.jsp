...
<style type="text/css">
    .buy_num{border: 1px solid #dbdbdb;line-height: 26px;overflow: hidden;}
    .buy_num em{display: block;height: 26px;width: 26px;float: left;color: #7A7979;border-right: 1px solid #dbdbdb;text-align: center;cursor: pointer;}
    .buy_num .num{display: block;float: left;text-align: center;width: 52px;font-style: normal;font-size: 14px;line-height: 24px;border: 0;}
    .buy_num em.add{float: right;border-right: 0;border-left: 1px solid #dbdbdb;}
</style>
<div class="content">
    <div class="card">
        ...
        <div class="popup popup-buy" style="bottom: 0;top: initial;">
            ...
            <div class="content-block">
                <div >
                                    ...
                                    <div class="item-inner">
                                        ...
                                        <div class="item-input">
                                            <div class="buy_num">
                                                ...
                                                <input type="text" id="buyNum" value="1" class="num button button-dark" style="height: 27px;width: 64%"/>
                                                <em class="add">+</em>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="content-block">
                        <div class="row">
                            <div class="col-100" style="text-align: center" id="subOrder"><a class="button button-big button-fill button-success" >确认提交</a></div>
                        </div>
                    </div>
                </div>
            </div>
