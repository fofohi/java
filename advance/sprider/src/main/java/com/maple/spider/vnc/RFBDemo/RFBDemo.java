package com.maple.spider.vnc.RFBDemo;


import com.maple.spider.vnc.RFBService.RFBService;
import com.maple.spider.vnc.RobotService.RobotKeyboard;
import com.maple.spider.vnc.RobotService.RobotMouse;
import com.maple.spider.vnc.RobotService.RobotScreen;
import com.maple.spider.vnc.SwingDemo.JFrameMainWindow;
...
public class RFBDemo {
	 ...
	 * @throws AWTException
	 */
	public static void startServer(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException, IOException, AWTException {
